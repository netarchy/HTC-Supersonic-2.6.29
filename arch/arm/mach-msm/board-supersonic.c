...
struct atmel_i2c_platform_data supersonic_atmel_ts_data[] = {
	{
		...
		.config_T9 = {139, 0, 0, 18, 12, 0, 16, 32, 3, 5, 0, 5, 2, 14, 5, 10, 25, 10, 0, 0, 0, 0, 0, 0, 0, 0, 143, 25, 146, 10, 40}, // setting [14] to 5 enables 5 pt multitouch, needs to be done for each controller version - netarchy
